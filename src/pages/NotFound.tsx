  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gloria-purple/95 to-gloria-deepPurple/95 text-white px-4 py-8">
      <div className="max-w-3xl w-full mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 md:p-10 shadow-2xl">
          {/* Contenido principal */}
          <div className="flex flex-col items-center text-center">
            {/* Pequeño texto de error 404 */}
            <div className="flex items-center gap-2 mb-4">
              <span className="text-gloria-gold font-serif text-lg md:text-xl">404</span>
              <Cross size={20} className="text-gloria-gold" />
              <span className="text-gloria-gold font-serif text-lg md:text-xl">Página no encontrada</span>
            </div>
            
            {/* Titular principal */}
            <h1 className="text-3xl md:text-5xl font-serif font-bold mb-6 text-gloria-cream">
              Esta página no sale
            </h1>
            
            {/* Separador decorativo - simula un varal */}
            <div className="w-full max-w-md h-px bg-gradient-to-r from-transparent via-gloria-gold to-transparent mb-6"></div>
            
            {/* Subtítulo */}
            <p className="text-xl md:text-2xl font-serif text-gloria-cream/90 mb-8">
              Esperamos que las Hermandades sí salgan
            </p>
            
            {/* Iconos decorativos de Semana Santa */}
            <div className="flex justify-center gap-8 mb-8">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-gloria-gold/20 rounded-full flex items-center justify-center mb-2">
                  <Cross className="text-gloria-gold w-8 h-8" />
                </div>
              ...
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-gloria-gold/20 rounded-full flex items-center justify-center mb-2">
                  <svg className="text-gloria-gold w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <Button
                asChild
                variant="outline"
                className="bg-gloria-gold/20 text-gloria-cream border-gloria-gold/50 hover:bg-gloria-gold/30 hover:text-white"
              >
        ...
        <div className="mt-8 max-w-lg mx-auto opacity-70">
